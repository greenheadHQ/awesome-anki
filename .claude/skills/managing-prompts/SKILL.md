...
description: >-
  Manage split-prompt versions, A/B experiments, and quality tracking.
  Includes Cloze Enhancer (binary pattern hints), SuperMemo Twenty Rules enforcement,
  card length limits, and failure pattern analysis.
---
