...
description: >-
  Generate and cache Gemini embeddings (gemini-embedding-001, 768-dim) for semantic similarity.
  Covers text preprocessing, incremental file-based cache, and cosine similarity.
---
